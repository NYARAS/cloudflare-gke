...
tunnel: ${cloudflare_argo_tunnel.appserver_tunnel.id}
...
resource "kubernetes_secret" "cloudflared" {
  ...
  data = {
    "credentials.json" = jsonencode({
      ...
      "TunnelID"     = cloudflare_argo_tunnel.appserver_tunnel.id,
      "TunnelName"   = cloudflare_argo_tunnel.appserver_tunnel.name,
